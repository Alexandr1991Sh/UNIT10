...
let ar2 = ['str1', 'str2', 123, 456, true, false];
function f2() {
    let out = '';
...
// let ar6 =
let ar6 = ['Alexandr', 'vodoley', 10, 'february']
...
function f8() {
    ...
    document.querySelector('.out-8').innerHTML = out1;
...
function f10() {
    ...
    document.querySelector('.out-10').innerHTML = num1 + num2;
}
